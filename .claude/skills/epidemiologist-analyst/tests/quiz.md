...
## Scenario 3: Vaccine-Preventable Disease Resurgence
...
**Analysis Task**:
Analyze the outbreak dynamics and recommend interventions.
...
4. **Historical Grounding** (0-10): Use of precedents, outbreak data, evidence-based interventions
