...
from ..orchestrator import Orchestrator, VM, VMOptions
from ..errors import ProvisioningError, CleanupError
...
class TestOrchestrator(unittest.TestCase):
    ...
    def test_provision_vm_quota_error(self, mock_run):
        ...
        mock_run.return_value = Mock(
            returncode=1,
            stderr='Quota exceeded for VM family'
        )
