"""VM configuration template management commands.

This module provides commands for creating, listing, deleting, importing,
and exporting VM configuration templates.
"""
...
from azlin.template_manager import (
    TemplateError,
    TemplateManager,
    VMTemplateConfig,
)
