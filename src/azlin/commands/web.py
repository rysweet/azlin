"""Web/PWA commands for azlin.

This module contains PWA-related CLI commands extracted from cli.py.
Part of Issue #423 - cli.py decomposition.

Commands:
    - web: Group for managing the Azlin Mobile PWA web server
    - web start: Start the Azlin Mobile PWA development server
    - web stop: Stop the Azlin Mobile PWA development server
"""
