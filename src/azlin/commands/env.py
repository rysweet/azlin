...
This module provides commands for managing environment variables on VMs.
"""
...
def register_env_commands(main: click.Group) -> None:
    """Register env commands with main CLI group.
