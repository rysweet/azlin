"""Environment variable management commands for azlin CLI.

This module provides the 'azlin env' command group for managing environment
variables on remote VMs via ~/.bashrc.

Commands:
    azlin env set <vm> KEY=VALUE    Set environment variable
    azlin env list <vm>             List environment variables
    azlin env delete <vm> <key>     Delete environment variable
    azlin env export <vm> [file]    Export to .env format
    azlin env import <vm> <file>    Import from .env file
    azlin env clear <vm>            Clear all environment variables
"""
...
__all__ = [
    "env",  # Alias for env_group for test compatibility
    "env_clear",
    "env_delete",
    "env_export",
    "env_group",
