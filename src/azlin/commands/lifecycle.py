...
This module contains VM lifecycle CLI commands extracted from cli.py.
Part of Issue #423 - cli.py decomposition.

Commands:
    - start: Start a stopped/deallocated VM
    - stop: Stop or deallocate a VM
    - kill: Delete a VM and all associated resources
    - destroy: Alias for kill with additional options (dry-run, delete-rg)
    - killall: Delete all VMs in resource group
    - prune: Prune inactive VMs based on age and idle time
"""
