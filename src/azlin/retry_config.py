...
class RetryConfig:
    ...
    including rate limiting handling.
    """
    ...
    rate_limit_max_wait: float = 300.0  # Max 5 minutes for rate limit
    rate_limit_default_backoff: float = 10.0  # Default if no Retry-After
    ...
    def from_environment(cls) -> "RetryConfig":
        ...
        Environment variables (all optional):
            ...
            AZLIN_RATE_LIMIT_MAX_WAIT: Max wait for rate limiting (default: 300.0)
            AZLIN_RATE_LIMIT_DEFAULT_BACKOFF: Default rate limit backoff (default: 10.0)
        ...
        # Rate limiting settings
        rate_limit_max_wait = float(os.getenv("AZLIN_RATE_LIMIT_MAX_WAIT", "300.0"))
        rate_limit_default_backoff = float(os.getenv("AZLIN_RATE_LIMIT_DEFAULT_BACKOFF", "10.0"))
        ...
        return cls(
            ...
            ssh_initial_delay=float(os.getenv("AZLIN_RETRY_SSH_INITIAL_DELAY", "2.0")),
            ...
            remote_command_initial_delay=float(
                os.getenv("AZLIN_RETRY_REMOTE_COMMAND_INITIAL_DELAY", str(default_initial_delay))
            ),
            ...
            rate_limit_default_backoff=rate_limit_default_backoff,
