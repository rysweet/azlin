"""CLI orchestration module for azlin.

This module contains the core workflow orchestration logic that coordinates
all azlin modules to execute the complete VM provisioning and management workflow.

The CLIOrchestrator class is responsible for:
- Prerequisites checking
- Azure authentication
- SSH key generation and management
- VM provisioning with Bastion detection
- Cloud-init waiting
...
Public API:
    AzlinError: Base exception for azlin errors
    CLIOrchestrator: Main workflow orchestration class
"""
...
__all__ = ["AzlinError", "CLIOrchestrator"]
...
class CLIOrchestrator:
    ...
    def _restore_ssh_keys_via_runcommand(self, vm_details: VMDetails, key_path: Path) -> None:
        ...
        try:
            ...
            # SECURITY: Use >> (append) for SSH keys per audit requirement
            script = f"""#!/bin/bash
