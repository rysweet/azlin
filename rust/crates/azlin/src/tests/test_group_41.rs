...
fn test_build_log_follow_args_has_tail_f() {
    let args = crate::connect_helpers::build_log_follow_args("user", "10.0.0.1", "/var/log/syslog");
...
fn test_build_log_tail_args_custom_lines() {
    let args =
        crate::connect_helpers::build_log_tail_args("user", "10.0.0.1", 100, "/var/log/auth.log");
