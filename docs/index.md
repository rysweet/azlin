...
- [`azlin list` Enrichment and Output Safety](./reference/list-enrichment-scope.md) — Why enrichment is gated on subscription identity, and what azlin guarantees about the bytes it prints
