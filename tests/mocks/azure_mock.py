...
class MockVirtualMachine:
    ...
    def __init__(self, name: str, location: str, vm_size: str, state: str = "Succeeded"):
        self.name = name
...
class MockPublicIPAddress:
    ...
    def __init__(self, name: str, ip_address: str = "20.123.45.67", location: str = "eastus"):
        self.name = name
...
class MockNetworkInterface:
    ...
    def __init__(self, name: str, public_ip_id: str, location: str = "eastus"):
        self.name = name
...
class MockVirtualMachinesOperations:
    ...
    def begin_create_or_update(
        ...
        vm = MockVirtualMachine(
            ...
            vm_size=parameters.get("properties", {})
            .get("hardwareProfile", {})
            .get("vmSize", "Standard_D2s_v3"),
        )
...
class MockVirtualNetworksOperations:
    ...
    def begin_create_or_update(
        ...
        """Mock VNet creation."""
        vnet = Mock(name=virtual_network_name, location=parameters.get("location", "eastus"))
...
class MockResourceGroupsOperations:
    ...
    def create_or_update(
        self, resource_group_name: str, parameters: dict[str, Any]
    ) -> MockResourceGroup:
        """Mock resource group creation."""
        rg = MockResourceGroup(
            name=resource_group_name, location=parameters.get("location", "eastus")
        )
