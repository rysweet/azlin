...
class TestVMConnector:
    ...
    def test_is_valid_ip_ipv4_edge_cases(self):
        ...
        # Valid edge cases
        assert VMConnector.is_valid_ip("0.0.0.0") is True  # noqa: S104 - Testing IP validation
    ...
    def test_is_valid_ip_invalid_edge_cases(self):
        ...
        # Non-numeric octets
        assert VMConnector.is_valid_ip("abc.def.ghi.jkl") is False
        # Hostname-like strings
        assert VMConnector.is_valid_ip("localhost") is False
        assert VMConnector.is_valid_ip("example.com") is False
